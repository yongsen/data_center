...
\begin{frame}{Failures handling and Multi-path TCP}
...
\begin{itemize}
  ...
  \item \textbf{Flexible switching} improves the capacity and reduces the delay: 10G $\rightarrow$ 20G, decoding after $\rightarrow$ as transmitting.
\end{itemize}
\end{block}
